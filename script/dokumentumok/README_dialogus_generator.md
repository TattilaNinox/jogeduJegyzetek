...
```bash
python create_natural_dialog.py
```
...
```bash
python create_natural_dialog.py "Tételek/A_cselekvokepesseg"
```

### Relatív útvonallal

```bash
python create_natural_dialog.py "../Masik_temakor"
```
...
python create_natural_dialog.py "Tételek/A_deliktualis_karfelelosseg"

# Cselekvőképesség
python create_natural_dialog.py "Tételek/A_cselekvokepesseg"

# Más témakör
python create_natural_dialog.py "Tételek/Masik_temakor"
```
